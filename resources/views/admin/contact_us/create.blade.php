    ...
    <div class="container-xxl">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <x-form.wrapper action="{{route('admin.contact-uses.store')}}" method="POST" enctype="multipart/form-data">
...
@push('custom_js')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\ContactUsRequest')->ignore("input:hidden:not(input:hidden.required), [contenteditable='true']"); !!}
