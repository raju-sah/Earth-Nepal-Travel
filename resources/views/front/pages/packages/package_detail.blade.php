...
@section('title', optional($packageDetails)->title)
...
<section class="introduction_content pt-5">
  <div class="container">
    <div class="text-wrapper row">
      <div class="col-sm-12">
        <h1 class="section_title mb-3">{{ optional($packageDetails)->title }}</h1>
        <figure class="float-right ml-md-3 mb-2 mb-sm-3 mw-sm-50"> <a href="#"><img src="{{optional($packageDetails)->banner_path}}" alt=""></a> </figure>
        <figcaption>
          <p>{!! optional($packageDetails)->overview !!}</p>
        </figcaption>
      </div>
    </div>
  </div>
...
<section class="destination-section">
  <div class="container">
    <h2 class="section_title mb-3"> Related Destinations </h2>
    <div class="row">
      @foreach($relatedDestinations as $other_destination)
