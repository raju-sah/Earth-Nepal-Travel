...
@section('title', 'Edit Booking Form')
@section('content')
    ...
    <div class="container-xxl">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <x-form.wrapper action="{{route('admin.booking-forms.update', $booking_form->id)}}" method="POST" enctype="multipart/form-data">
                    @method('PATCH')
                    ...
                    <div class="banner-thumb mt-3" style="width: 150px; aspect-ratio: 4/3; position: relative;" id="banner_image">
                        <img src="{{$booking_form->banner_path}}" alt="title" class="w-100 card-img">
                    ...
                    <x-form.input type="text" label="Page_title" :req="true" id="page_title" name="page_title" value="{{$booking_form->page_title}}"/>
                    ...
                    <x-form.single_preview id="image-thumb" url="{{$booking_form->image_path}}"/>
                    <x-form.input type="text" label="Content_title" id="content_title" name="content_title" value="{{$booking_form->content_title}}"/>
                    <x-form.textarea label="Description" id="description" :req="true" name="description" value="{!! $booking_form->description !!}" rows="5" cols="5"/>
...
@endsection
@push('custom_js')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\BookingFormUpdateRequest')->ignore("input:hidden:not(input:hidden.required), [contenteditable='true']"); !!}
