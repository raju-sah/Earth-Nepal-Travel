...
<div class="container-xxl">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <x-form.wrapper action="{{route('admin.booking-forms.store')}}" method="POST" enctype="multipart/form-data">
...
@push('custom_js')
{!! JsValidator::formRequest('App\Http\Requests\Admin\BookingFormRequest')->ignore("input:hidden:not(input:hidden.required), [contenteditable='true']"); !!}
